...
if(b._ba!==0&&(b._ba>=6||b._ca>100+b._da)){b._ha=1;ya=true;}
b._na();b._ba++;if(ya){return;}
dT_.st(b._la,100);};b._oa=function(za){var Aa=za.toString();return Aa.substring(Aa.indexOf(' ')+1,Aa.indexOf('('));};b._pa=function(){if(b._ha&&(dT_.nw()-b._ia)<b._aa){return;}
dT_.st(b._la,100);};b._qa=function(){var Ba=dT_.lv(b._ka);if(Ba){var ps=Ba.split('|');lastCheckTime=ps[0];if((dT_.nw()-lastCheckTime)<b._aa&&ps.length==6){b._ia=ps[0];b._ba=ps[1];b._ca=isNaN(ps[2])?0:ps[2];b._da=isNaN(ps[3])?0:ps[3];b._ha=parseInt(ps[4],10);b._ga=parseInt(ps[5],10);}}};b._na=function(){dT_.sv(b._ka,b._ia+'|'+b._ba+'|'+b._ca+'|'+b._da+'|'+b._ha+'|'+b._ga);};var bw=dT_.cfg('bandwidth');if(bw&&dT_.tp()&&dT_.smbi('b')){if(b._ja){if(bw.indexOf('m')==-1){return;}
...
b._qa();dT_.asl(function(Da,Ea){if(!Ea&&b._ba>0&&b._ha&&!b._ga){Da.a('bw',b._ba+'_'+b._ca);b._ga=1;b._na();}});dT_.st(b._pa,2000);dT_.bwo=b;}})();(function(){var j={};j._aa=function(na,oa){var lx=false;function checkLx(pa){if(lx===false){lx=true;dT_.st(function(){dT_.lx(pa);},0);}}
if(typeof na==="object"){oa=na;}
oa=oa||{};var qa=dT_.ex('jQuery.ajax',3);var ra;if((oa.async===undefined)||oa.async){var sa=oa.complete;oa.complete=function(ta,ua){if(ua!="success"){dT_.pw('jQuery reported "'+ua+'"');}
dT_.ec(qa);var va=undefined;if(sa){if(typeof sa=='function'){va=sa.apply(this,arguments);}else if(sa.length){for(var i=0;i<sa.length;i++){sa[i].apply(this,arguments);}}}
dT_.lc(qa);checkLx(qa);return va;};var wa=oa.success;if(wa){oa.success=function(xa,ya,za){dT_.ec(qa);var Aa=undefined;if(typeof wa=='function'){Aa=wa.apply(this,arguments);}else if(wa.length){for(var i=0;i<wa.length;i++){wa[i].apply(this,arguments);}}
dT_.lc(qa);checkLx(qa);return Aa;};}
var Ba=oa.error;if(Ba){oa.error=function(Ca,Da,Ea){dT_.ec(qa);var Fa=Ba.apply(this,arguments);dT_.lc(qa);checkLx(qa);return Fa;};}
ra=j._ea.apply(this,arguments);}
else{dT_.ec(qa);ra=j._ea.apply(this,arguments);dT_.lc(qa);checkLx(qa);}
return ra;};j._fa=function(Ga,Ha){if(Ga){var Ia=function(e){var Ja=null;if(e.currentTarget){Ja=dT_.bi(e.currentTarget,Ha,'jquery');}
else if(e.srcElement){Ja=dT_.bi(e.srcElement,Ha,'jquery');}
var Ia=Ga.apply(this,arguments);if(Ja){dT_.st(function(){dT_.ei(Ja);},50);}
return Ia;};Ia._ga=true;Ia._ha=Ga;return Ia;}else{return Ga;}};j._ia=function(Ka,La){var Ma=Ka[La];if(Ma){for(var i=0;i<Ma.length;i++){if(Ma[i].handler&&!Ma[i].handler._ga){Ma[i].handler=j._fa(Ma[i].handler,La);}}}};j._ja=function(Na,Oa,Pa){var Qa=j._ka.apply(this,arguments);if(typeof Qa!='undefined'&&Qa){if(Oa=='events'){j._ia(Qa,'click');j._ia(Qa,'mouseup');j._ia(Qa,'mousedown');j._ia(Qa,'keydown');j._ia(Qa,'autocomplete');}}
return Qa;};j._la=function(){var Ra=arguments;if(Ra.length==3&&Ra[2]&&typeof Ra[2]._ha!=="undefined"){Ra[2]=Ra[2]._ha;}
return j._ma.apply(this,Ra);};if(dT_.smbi('j')){dT_.all(function(){if(typeof jQuery!='undefined'){dT_.ti();j._ea=jQuery.ajax;jQuery.ajax=j._aa;j._ka=jQuery.data;jQuery.data=j._ja;j._ma=jQuery.fn.off;jQuery.fn.off=j._la;dT_.ael(window,'unload',function(){if(j){if(typeof jQuery!='undefined'){jQuery.ajax=j._ea;jQuery.data=j._ka;jQuery.fn.off=j._ma;}
j._ma=null;j._ea=null;j._ka=null;j=null;}});}});}})();(function(){var ob=function(pb,qb){pb.push(qb);};var rb=function(){this._ba=null;this._ca=function(sb,tb){if(sb>tb){throw 'Error: Start('+sb+') must be before stop ('+tb+')';}
