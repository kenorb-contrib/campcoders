...
class Spyropress {
    ...
    function includes() {
        ...
        if( $this->is_builder_verified && $this->is_builder_installed )
    ...
    function load_textdomain() {
        ...
        load_textdomain( $this->domain, $this->template_path . 'lang/' . "$locale.mo" );

        // Load admin specific MO files
        if ( is_admin() ) {
            load_textdomain( $this->domain, $this->framework_path . 'lang/' . "spyropress-admin-$locale.mo" );
        }
    }
