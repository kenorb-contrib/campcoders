    ...
    public function __construct() {
        ...
        $this->fields = array(
            ...
            array(
                ...
                'label' => 'Style/Skin',
                'options' => array(
                    'home-intro' => 'Call of Action',
                    'featured_section call-to-action footer' => 'Call-to-Action (Featured)',
                    'home-intro light' => 'Call of Action (Light)',
                    'home-concept' => 'Home Concept',
                    'featured_section' => 'Featured Section',
                    'highlight_section' => 'Hightlight',
                    'highlight_section top' => 'Hightlight (no top-margin)',
                    'featured_section highlight_section footer' => 'Featured Hightlight Section',
                    'pull-top' => 'Pull Top',
                    'parallax' => 'Parallax'
                )
            ),
