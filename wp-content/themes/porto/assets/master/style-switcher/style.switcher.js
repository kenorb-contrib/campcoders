...
var styleSwitcher = {
	...
	initialize: function() {
		...
		$.styleSwitcherCachedScript( theme_settings.assets + "master/style-switcher/colorpicker/js/colorpicker.js").done(function(script, textStatus) {

			less = {
				env: "development"
			};

			$.styleSwitcherCachedScript( theme_settings.assets + "master/less/less.js").done(function(script, textStatus) {
		...
		$.styleSwitcherCachedScript( theme_settings.assets + "master/style-switcher/cssbeautify/cssbeautify.js").done(function(script, textStatus) {});
	},
