...
<div class="header4">
    ...
    <div class="logo">
			...
			<?php if ( is_home() ) { ?>   
            <h1><a  href="<?php echo esc_url( home_url( '/' ) );?>"><?php bloginfo('name'); ?></a><p><?php bloginfo('description'); ?></p></h1>
            <?php }else{ ?>
            <h2><a href="<?php echo esc_url( home_url( '/' ) );?>"><?php bloginfo('name'); ?></a><p><?php bloginfo('description'); ?></p></h2>
            <?php } ?>
